...
[UKPlugin("Custom Arms", "1.0.0", "Lorem ipsum dolor sit amet, consectetur adipiscing elit.Integer porta sed ipsum in tempus. Suspendisse enim mi, interdum non dictum eget, posuere vitae ligula. Proin nibh orci, feugiat ut ante nec, lacinia mollis augue.Donec id tortor vitae neque egestas faucibus.Morbi at mauris at tellus semper fringilla.Suspendisse tristique ligula tincidunt turpis congue, non sollicitudin tortor pharetra.Maecenas suscipit risus eu dolor fermentum, ac dignissim sapien placerat.Sed hendrerit consectetur ligula a tempus. Nullam tortor sapien, cursus nec vehicula bibendum, viverra quis neque.Vestibulum tincidunt convallis convallis.Sed orci enim, pretium nec orci in, pretium feugiat neque.Fusce sapien justo, semper pellentesque consequat nec, aliquet vel eros.Donec rutrum aliquam rutrum.Maecenas aliquam elementum turpis ut viverra.Suspendisse finibus metus odio, volutpat egestas metus ultricies sit amet.Sed vel risus enim. Nulla quis consectetur mi.Ut elit ex, scelerisque lobortis augue eget, efficitur dapibus dui.Suspendisse elit lectus, volutpat id iaculis vitae, convallis a nulla.Etiam leo urna, ullamcorper ac mattis tempus, convallis non leo.Nullam tristique purus tellus, id vestibulum ex imperdiet a.Integer a felis leo.Ut sit amet enim eget mauris consequat congue quis ut tellus.Sed porta rhoncus lorem dapibus molestie. Suspendisse eros lacus, condimentum eu orci vel, vulputate vehicula diam.Curabitur id venenatis ipsum.Vestibulum tempor mi sit amet laoreet finibus.Phasellus sed cursus felis.Vivamus sodales vehicula lorem, iaculis feugiat enim.Vivamus semper justo augue, sed congue nisl mollis a.Aliquam finibus nisl eu laoreet tincidunt.Aliquam fringilla semper ex, non sollicitudin dolor laoreet vel.Nullam auctor metus nec ante malesuada viverra. Fusce eget elementum neque.Morbi non dolor ex.Fusce lacinia felis non odio elementum dictum.Vestibulum mattis nunc vel tortor euismod accumsan.Fusce pulvinar quis libero ac vulputate.Sed maximus leo et sapien facilisis imperdiet.Quisque at nisi a turpis malesuada volutpat vel eget nibh.Phasellus rhoncus, ipsum quis euismod finibus, nunc lectus semper nisi, ut pharetra enim leo ac lacus.Nulla in ligula erat.Curabitur egestas pharetra molestie.Donec elementum cursus nisi in condimentum.Cras quis pellentesque neque.", false, true)]
